...
<div class="row g-4">
            ...
            <div class="card-body p-4">
                <form action="{{ route('mata-kuliah.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="mata_kuliah_id" class="form-select bg-light" id="courseSelect">
                    ...
                    <div id="newCourseFields" class="bg-light p-3 rounded-3 mb-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" id="course_nama" placeholder="Contoh: Algoritma">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-medium">Kode MK</label>
                            <input type="text" name="kode" class="form-control" id="course_kode" placeholder="Contoh: AL01">
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="tipe" class="form-select" id="course_tipe" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="dosen_id" class="form-select bg-primary-subtle border-primary-subtle" required>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                @php
                    $groupedCourses = $mataKuliah->groupBy('semester')->sortKeys();
                @endphp
                ...
                @forelse($groupedCourses as $semester => $semesterCourses)
                    ...
                    <div class="table-responsive border rounded-3 mb-2">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach($semesterCourses as $mk)
                                <tr>
                                    <td class="ps-3 py-3">
                                        <span class="badge bg-light text-dark border px-2 py-1">{{ $mk->kode }}</span>
                                    </td>
                                    <td class="py-3">
                                        <div class="d-flex justify-content-between align-items-center me-3">
                                            <div class="fw-bold text-dark">{{ $mk->nama }}</div>
                                            <button class="btn btn-sm btn-link text-decoration-none p-0" data-bs-toggle="modal" data-bs-target="#editCourseModal{{ $mk->id }}">
                                                ...
                                                <div class="modal-content border-0 shadow-lg rounded-4">
                                                    <form action="{{ route('mata-kuliah.update', $mk->id) }}" method="POST">
                                                        ...
                                                        <div class="modal-body p-4 text-start">
                                                            <div class="mb-3">
                                                                <label class="form-label fw-medium">Nama Mata Kuliah</label>
                                                                <input type="text" name="nama" class="form-control bg-light" value="{{ $mk->nama }}" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-medium">Kode MK</label>
                                                                <input type="text" name="kode" class="form-control bg-light" value="{{ $mk->kode }}">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="form-label fw-medium">SKS Default</label>
                                                                    <input type="number" name="sks" class="form-control bg-light" value="{{ $mk->sks }}" min="1" max="6" required>
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="form-label fw-medium">Jenis Default</label>
                                                                    <select name="tipe" class="form-select bg-light" required>
                                                                        <option value="theory" {{ $mk->tipe == 'theory' ? 'selected' : '' }}>Teori</option>
                                                                        <option value="lab" {{ $mk->tipe == 'lab' ? 'selected' : '' }}>Praktikum</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="form-label fw-medium">Semester</label>
                                                                    <select name="semester" class="form-select bg-light">
                                                                        ...
                                                                        <option value="2" {{ $mk->semester == 2 ? 'selected' : '' }}>Sem 2</option>
                                                                        <option value="4" {{ $mk->semester == 4 ? 'selected' : '' }}>Sem 4</option>
                                                                        <option value="6" {{ $mk->semester == 6 ? 'selected' : '' }}>Sem 6</option>
                                                                        <option value="8" {{ $mk->semester == 8 ? 'selected' : '' }}>Sem 8</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer border-top-0 pb-4 px-4 d-flex justify-content-between">
                                                            <button type="button" class="btn btn-outline-danger rounded-pill px-4" onclick="if(confirm('Hapus MK ini beserta seluruh plottingnya?')) document.getElementById('deleteCourse{{ $mk->id }}').submit()">Hapus MK</button>
                                                            <div>
                                                    ...
                                                    <form id="deleteCourse{{ $mk->id }}" action="{{ route('mata-kuliah.destroy', $mk->id) }}" method="POST" style="display:none;">
                                                        @csrf @method('DELETE')
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="list-group list-group-flush">
                                            @foreach($mk->kelas as $k)
                                                <div class="list-group-item bg-transparent d-flex justify-content-between align-items-center border-0 py-2 ps-0 pe-3">
                                                    <div>
                                                        <div class="small fw-bold">{{ $k->dosen?->nama ?? 'Dosen Tidak Ditemukan' }}</div>
                                                        <div class="d-flex gap-1 mt-1">
                                                            <span class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill" style="font-size: 0.6rem;">{{ $k->sks }} SKS</span>
                                                            <span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle rounded-pill" style="font-size: 0.6rem;">{{ $k->tipe == 'theory' ? 'Teori' : 'Praktikum' }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex gap-2">
                                                        <button class="btn btn-sm btn-light border rounded-circle p-0" style="width: 24px; height: 24px;" data-bs-toggle="modal" data-bs-target="#editOfferingModal{{ $k->id }}" title="Edit Plotting"><i class="bi bi-pencil-fill" style="font-size: 0.65rem;"></i></button>
                                                        <form action="{{ route('kelas.destroy', $k->id) }}" method="POST" onsubmit="return confirm('Hapus plotting ini?')">
                                                            @csrf @method('DELETE')
                                                    ...
                                                    <!-- Edit Offering Modal -->
                                                    <div class="modal fade" id="editOfferingModal{{ $k->id }}" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content border-0 shadow-lg rounded-4">
                                                                <form action="{{ route('kelas.update', $k->id) }}" method="POST">
                                                                    ...
                                                                    <div class="modal-body p-4 text-start">
                                                                        <div class="p-3 bg-light rounded-3 mb-3">
                                                                            ...
                                                                            <div class="fw-bold text-primary">{{ $mk->nama }}</div>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label fw-medium">Dosen Pengampu</label>
                                                                            <select name="dosen_id" class="form-select" required>
                                                                                @foreach($dosen as $d)
                                                                                    <option value="{{ $d->id }}" {{ $k->dosen_id == $d->id ? 'selected' : '' }}>{{ $d->nama }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6 mb-0">
                                                                                <label class="form-label fw-medium">SKS</label>
                                                                                <input type="number" name="sks" class="form-control" value="{{ $k->sks }}" min="1" max="6" required>
                                                                            </div>
                                                                            <div class="col-md-6 mb-0">
                                                                                <label class="form-label fw-medium">Jenis</label>
                                                                                <select name="tipe" class="form-select" required>
                                                                                    <option value="theory" {{ $k->tipe == 'theory' ? 'selected' : '' }}>Teori</option>
                                                                                    <option value="lab" {{ $k->tipe == 'lab' ? 'selected' : '' }}>Praktikum</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<script>
    ...
    courseSelect.addEventListener('change', function() {
        if (this.value) {
            ...
            document.getElementById('course_tipe').value = selected.getAttribute('data-tipe');
    ...
    const codeInput = document.getElementById('course_kode');
