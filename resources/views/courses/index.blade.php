                    ...
                    <div class="mb-3">
                        ...
                        <select name="course_id" class="form-select bg-light" id="courseSelect">
                            ...
                            @foreach($courses as $c)
                                <option value="{{ $c->id }}" data-name="{{ $c->name }}" data-code="{{ $c->code }}" data-sks="{{ $c->sks }}" data-type="{{ $c->type }}">
                                    [{{ $c->code }}] {{ $c->name }}
                                </option>
                            @endforeach
                        </select>
                                        ...
                                        @foreach($c->offerings as $o)
                                            <div class="list-group-item bg-transparent d-flex justify-content-between align-items-center border-0 py-2 ps-0 pe-4">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-sm btn-light border rounded-circle p-0" style="width: 28px; height: 28px;" data-bs-toggle="modal" data-bs-target="#editOfferingModal{{ $o->id }}" title="Edit Plotting"><i class="bi bi-pencil-fill" style="font-size: 0.75rem;"></i></button>
